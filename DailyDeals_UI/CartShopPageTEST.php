                    ...
                    <div class="col-lg-3">
                        <div class="hero__categories">
                            ...
                            <ul id="category-list">
                                ...
                                <li><a href="CartShopPageTEST.php?category=2" data-category="vegetables">Vegetables</a></li>
                                <li><a href="CartShopPageTEST.php?category=3" data-category="dairy">Milk Product</a></li>
                                <li><a href="CartShopPageTEST.php?category=1" data-category="grocery">Fruit</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-5">
                        <div class="sidebar">
                            <div class="sidebar__item">
                                <h4>Department</h4>
                                <ul>
                                    <li><a href="CartShopPageTEST.php?category=2">Vegetables</a></li>
                                    <!-- <li><a href="#">Fruit </a></li> -->
                                    <li><a href="CartShopPageTEST.php?category=3">Dairy </a></li>
                                    <!-- <li><a href="#">Cold Drink </a></li> -->
                                    <li><a href="CartShopPageTEST.php?category=1">Fruits </a></li>
...
$sql = "SELECT ProductID, Name, Price, ImageURL FROM product WHERE 1=1";
if (!empty($searchTerm)) {
