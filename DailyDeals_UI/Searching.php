...
<html lang="zxx">
                            ...
                            <div class="hero__search__form">
                                <form method="GET">
                                    <div id="search-container">
                                        <input type="text" id="search-bar" name="search" placeholder="What do you need?" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo '    <div class="product__discount__item__pic" style="background-image: url(\'img/product/' . htmlspecialchars($row['image']) . '\');">';
            if ($row['discount'] > 0) {
                echo '        <div class="product__discount__percent">-' . htmlspecialchars($row['discount']) . '%</div>';
            }
            echo '    </div>';
            echo '    <div class="product__discount__item__text">';
            echo '        <span>' . htmlspecialchars($row['category']) . '</span>';
            echo '        <h5><a href="#">' . htmlspecialchars($row['name']) . '</a></h5>';
            echo '        <div class="product__item__price">₹' . htmlspecialchars($row['price']) . ' <span>₹' . htmlspecialchars($row['original_price']) . '</span></div>';
            echo '    </div>';
            echo '</div>';
        }
    } else {
