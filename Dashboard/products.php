...
<head>
    ...
    <!--title-->
    <title>
            Products : DailyDeals Online Store
    </title>
...
<body>
 ...
 <img src="https://grostore.themetags.com/public/uploads/media/yqqPV512Gk5DMpvCj2UllKrCl52bam3yD6QvfiPP.png" class="tt-brand-favicon ms-1" alt="favicon" />
    ...
    <li class="side-nav-item nav-item">
        <a href="http://localhost/DailyDeals/Dashboard/Test_Dashboard.php" class="side-nav-link">
                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                               <!-- <a href="https://grostore.themetags.com/admin/products/products/export" class="btn btn-danger"> <i
                                        data-feather="download"></i> Export</a>-->

                                <button class="btn btn-primary import"> <i data-feather="upload"></i>
                                    Import</button>

                                                                    <a href="http://localhost/DailyDeals/Dashboard/add_Products.php" class="btn btn-primary"><i
                                            data-feather="plus"></i> Add Product</a>
                                 <a href="http://localhost/DailyDeals/Dashboard/Update_Products.php" class="btn btn-primary"><i
                                            data-feather="plus"></i> Update Product</a>
                                 <a href="http://localhost/DailyDeals/Dashboard/Delete_Product.php" class="btn btn-primary"><i
                                            data-feather="plus"></i> Delete Product</a>
                                                            </div>
                        </div>
                    </div>
                </div>
...
//$sql = "SELECT ProductID, Name, Description, CategoryID, Price, ImageURL, StockQuantity, CreatedAt, UpdatedAt, IsActive FROM product";
//$result = $conn->query($sql);
//
//// If records are found, display them in the specified table format
//if ($result->num_rows > 0) {
//    echo '<table class="table tt-footable border-top" data-use-parent-width="true">
//            <thead>
//                <tr>
//                    <th class="text-center">S/L</th>
//                    <th>Product Name</th>
//                    <th data-breakpoints="xs sm">Description</th>
//                    <th data-breakpoints="xs sm">Category ID</th>
//                    <th data-breakpoints="xs sm">Price</th>
//                    <th data-breakpoints="xs sm">Image URL</th>
//                    <th data-breakpoints="xs sm">Stock Quantity</th>
//                    <th data-breakpoints="xs sm">Created At</th>
//                    <th data-breakpoints="xs sm">Updated At</th>
//                    <th data-breakpoints="xs sm md" class="text-end">Status</th>
//                   
//                </tr>
//            </thead>
//            <tbody>';
...
//        echo '<td><img src="' . $row["ImageURL"] . '" alt="Image" width="100"></td>'; // Display image
...
////        echo '<div class="dropdown tt-tb-dropdown">';
////        echo '<button type="button" class="btn p-0" data-bs-toggle="dropdown" aria-expanded="false">';
////        echo '<i data-feather="more-vertical"></i>';
////        echo '</button>';
////        echo '<div class="dropdown-menu dropdown-menu-end shadow">';
////        echo '<a class="dropdown-item" href="update_Products.php?ProductID=' . $row["ProductID"] . '"><i data-feather="edit-3" class="me-2"></i>Edit</a>';
////        echo '<a class="dropdown-item" href="Delete_Product.php?ProductID=' . $row["ProductID"] . '"><i data-feather="eye" class="me-2"></i>View Details</a>';
////        echo '<a href="#" class="dropdown-item confirm-delete" data-href="delete-product.php?ProductID=' . $row["ProductID"] . '" title="Delete"><i data-feather="trash-2" class="me-2"></i>Delete</a>';
////        echo '</div>';
//        echo '</div>';
//        echo '</td>';
//        echo '</tr>';
...
$sql = "SELECT ProductID, Name, Description, CategoryID, Price, ImageURL, StockQuantity, CreatedAt, UpdatedAt, IsActive 
        FROM product 
...
<!--pagination start-->
        ...
        <ul class="pagination">
                    ...
                    <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                        ...
                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/products?page=2">2</a></li>
                                                                        
            
                            <li class="page-item">
                    <a class="page-link" href="https://grostore.themetags.com/admin/products?page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                </li>
                    </ul>
    </nav>
    ...
    <div class="modal fade" id="import" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <form action="http://localhost/SEM_4_DailyDeals/Dashboard/ImportData_Store.php" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO" autocomplete="off">                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            ...
                            <label for="import" class="h6 mb-0">Import File</label>
                            <a href="https://grostore.themetags.com/public/sample_product.xlsx" douwnload class="btn btn-sm rounded-pill btn-secondary py-1 px-2 fs-ms"><i
                                data-feather="download"></i> Sample File</a>
                        </div>
...
<script>
    ...
    <!-- scripts from different pages -->
        ...
        function updateFeatureStatus(el) {
            ...
            $.post('https://grostore.themetags.com/admin/products/update-featured-product', {
                    _token: 'jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO',
                    id: el.value,
                    status: status
                },
        ...
        function updatePublishedStatus(el) {
            ...
            $.post('https://grostore.themetags.com/admin/products/update-published-product', {
                    _token: 'jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO',
                    id: el.value,
                    status: status
                },
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/products?lang_key=' + langKey + '&localize';
        }
