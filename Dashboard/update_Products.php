...
<head>
    ...
    <!--title-->
    <title>
            Update Product : DailyDeals Online Store
    </title>
 <style>/* styles.css */
                                ...
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Update Product <sup
                                                class="badge bg-soft-warning px-2">en</sup></h2>
                                    </div>
                                </div>
<!--                                <div class="col-4 col-md-2">
                                    <select id="language" class="w-100 form-control text-capitalize country-flag-select"
                                        data-toggle="select2" onchange="localizeData(this.value)">
                                                                                    <option value="en"
                                                selected
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/en.png?v=v4.3.0">
                                                English
                                            </option>
                                                                                    <option value="hi"
                                                
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/in.png?v=v4.3.0">
                                                हिंदी
                                            </option>
                                                                                    <option value="ar-sa"
                                                
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/sa.png?v=v4.3.0">
                                                Arabic
                                            </option>
                                                                                    <option value="fr"
                                                
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/fr.png?v=v4.3.0">
                                                Français
                                            </option>
                                                                                    <option value="fr/FR"
                                                
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/ad.png?v=v4.3.0">
                                                French
                                            </option>
                                                                                    <option value="es"
                                                
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/es.png?v=v4.3.0">
                                                es
                                            </option>
                                                                                    <option value="pt-BR"
                                                
                                                data-flag="https://grostore.themetags.com/public/backend/assets/img/flags/br.png?v=v4.3.0">
                                                Portugues
                                            </option>
                                                                            </select>
                                </div>-->
...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($_FILES['ImageUpload']['error'] == UPLOAD_ERR_OK) {
            ...
            $upload_dir = 'uploads/';
            $imageUrl = $upload_dir . basename($_FILES['ImageUpload']['name']);
            move_uploaded_file($tmp_name, $imageUrl);
        } else {
            $imageUrl = $_POST['ImageURL'] ?? '';
        }

        $sql = "UPDATE product SET Name='$name', Description='$description', CategoryID='$categoryId', Price='$price', 
                ImageURL='$imageUrl', StockQuantity='$stockQuantity', IsActive='$isActive' WHERE ProductID='$productId'";
    ...
    $productsResult = $conn->query("SELECT ProductID, Name FROM product");
    $products = [];
    ...
    // Fetch product details for Update operation
    ...
    <form method="post" action="" enctype="multipart/form-data" class="product-form">
        <div class="form-group">
            ...
            <select id="ProductID" name="ProductID" onchange="fetchProductData(this.value)" required class="form-select">
                <option value="">Select Product</option>
                <?php foreach ($products as $product): ?>
                    <option value="<?php echo htmlspecialchars($product['ProductID']); ?>" <?php echo isset($productData['ProductID']) && $productData['ProductID'] == $product['ProductID'] ? 'selected' : ''; ?>>
        ...
        <div class="form-group">
            ...
            <input type="text" id="Name" name="Name" value="<?php echo htmlspecialchars($productData['Name'] ?? ''); ?>" class="form-control">
        </div>

        <div class="form-group">
            <label for="Description">Description:</label>
            <textarea id="Description" name="Description" class="form-control"><?php echo htmlspecialchars($productData['Description'] ?? ''); ?></textarea>
        </div>

        <div class="form-group">
            <label for="CategoryID">Category ID:</label>
            <input type="number" id="CategoryID" name="CategoryID" value="<?php echo htmlspecialchars($productData['CategoryID'] ?? ''); ?>" class="form-control">
        </div>

        <div class="form-group">
            <label for="Price">Price:</label>
            <input type="text" id="Price" name="Price" value="<?php echo htmlspecialchars($productData['Price'] ?? ''); ?>" class="form-control">
        </div>

        <div class="form-group">
            <label for="ImageURL">Image URL:</label>
            <input type="text" id="ImageURL" name="ImageURL" value="<?php echo htmlspecialchars($productData['ImageURL'] ?? ''); ?>" readonly class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="StockQuantity" name="StockQuantity" value="<?php echo htmlspecialchars($productData['StockQuantity'] ?? ''); ?>" class="form-control">
        </div>

        <div class="form-group">
            <label for="IsActive">Active:</label>
            <input type="checkbox" id="IsActive" name="IsActive" <?php echo isset($productData['IsActive']) && $productData['IsActive'] == 1 ? 'checked' : ''; ?>>
        </div>
    ...
    if (productId) {
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                ...
                document.getElementById('IsActive').checked = data.IsActive === Active;
            }
        };
        xhr.send();
    } else {
...
<script>
    ...
    $('.themeChange').on('change', function(e) {
        ...
        $.ajax({
            method: "GET",
            url: "https://grostore.themetags.com/admin/products/update-product/34",
            data: {
                ids: $(this).val()
            },
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/products/update-product/34?lang_key=' + langKey + '&localize';
        }
