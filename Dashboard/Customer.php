            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        <form class="app-search" action="https://grostore.themetags.com/admin/customers" method="GET">
    ...
    <table class="table tt-footable border-top" data-use-parent-width="true">
        <thead>
            <tr>
                ...
                <th data-breakpoints="xs sm" class="text-end">Banned</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<tr>';
                    echo '<td class="text-center">' . $row["CID"] . '</td>'; // S/L
                    echo '<td>' . $row["C_Name"] . '</td>'; // Name
                    echo '<td>' . $row["Email"] . '</td>'; // Email
                    echo '<td>' . $row["Contact_No"] . '</td>'; // Phone
                    echo '<td class="text-end">';
                    echo '<div class="form-check form-switch d-flex justify-content-end">';
                    echo '<input type="checkbox" onchange="updateBanStatus(this)" class="form-check-input" value="' . $row["CID"] . '">'; // Banned
                    echo '</div>';
                    echo '</td>';
                    echo '</tr>';
                }
        ...
        <ul class="pagination">
                    ...
                    <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                        ...
                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/customers?page=2">2</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/customers?page=3">3</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/customers?page=4">4</a></li>
                                                                        
            
                            <li class="page-item">
                    <a class="page-link" href="https://grostore.themetags.com/admin/customers?page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                </li>
                    </ul>
    </nav>
        ...
        <div class="row g-3">
            <div class="col-md-6 order-last order-md-first">
                <div class="copyright text-center text-md-start">
                    © All Designed, Developed and 💕 by <b><font color="#ff9c00">ADGroup</font></b>
                </div>
            </div>
            <div class="col-md-6">
...
<script>
    ...
    <!-- scripts from different pages -->
        ...
        function updateBanStatus(el) {
            ...
            $.post('https://grostore.themetags.com/admin/customers/update-banned-customer', {
                    _token: 'jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO',
                    id: el.value,
                    status: status
                },
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/customers?lang_key=' + langKey + '&localize';
        }
