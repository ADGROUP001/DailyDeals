...
<head>
    ...
    <!--title-->
    <title>
            Add New Category : DailyDeals Online Store
    </title>
...
<!--                    <form action="http://localhost/SEM_4_DailyDeals/Dashboard/Store_Category_Database.php" method="POST" class="pb-650">
                        <input type="hidden" name="_token" value="jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO" autocomplete="off">                        basic information start
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                <h5 class="mb-4">Basic Information</h5>

                                <div class="mb-4">
                                    <label for="category_id" class="form-label">Themes <span
                                            class="text-danger">*</span> </label>
                                    <select class="form-control select2" name="theme_ids[]"
                                        data-placeholder="Select themes" data-toggle="select2" multiple
                                        required>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" id="description"
                                        placeholder="Type your category description" name="description">
                                </div>
...
<form action="update_category.php" method="POST" enctype="multipart/form-data" class="pb-650" id="update-category-form">
    ...
    <div class="card mb-4" id="section-1">
        <div class="card-body">
            <h5 class="mb-4">Update Category Information</h5>
            ...
            <input type="checkbox" id="active" name="active" value="1" <?php echo ($category['active'] == 1) ? 'checked' : ''; ?>><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE category SET Category_name = ?, description = ?, active = ? WHERE CategoryID = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssii", $categoryName, $description, $active, $categoryID);
...
<script>
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/products/add-category?lang_key=' + langKey + '&localize';
        }
