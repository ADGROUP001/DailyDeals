...
<head>
    ...
    <!--title-->
    <title>
            Orders : DailyDeals Online Store
    </title>
...
<div class="offcanvas offcanvas-start tt-aside-navbar" id="offcanvasLeft" tabindex="-1">
    ...
    <!-- orders -->
            <li
            class="side-nav-item nav-item tt-menu-item-active">
                                ...
                                <div class="row justify-content-between g-3">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        <div class="input-group mb-3">
                                                    ...
                                                    <span
                                                        class="input-group-text rounded-end-0">#G-Store:</span>
                                                </div>
...
$sql = "SELECT o.OrderID, o.CID, o.OrderDate, COUNT(oi.OrderItemID) AS Items, 
...
// Check if filters are set and add to conditions
if (!empty($_GET['search'])) {
    $search = $conn->real_escape_string($_GET['search']);
    $conditions[] = "(o.CID LIKE '%$search%' OR o.OrderID LIKE '%$search%')";
}

if (!empty($_GET['code'])) {
    $code = $conn->real_escape_string($_GET['code']);
    $conditions[] = "o.OrderID = '$code'";
}

if (!empty($_GET['payment_status'])) {
    $payment_status = $conn->real_escape_string($_GET['payment_status']);
    $conditions[] = "p.PaymentStatus = '$payment_status'";
}

if (!empty($_GET['delivery_status'])) {
    $delivery_status = $conn->real_escape_string($_GET['delivery_status']);
    $conditions[] = "o.OrderStatus = '$delivery_status'";
}

if (!empty($_GET['location_id'])) {
    $location_id = $conn->real_escape_string($_GET['location_id']);
    $conditions[] = "o.LocationID = '$location_id'";
}

if (isset($_GET['is_pos_order'])) {
    $is_pos_order = $conn->real_escape_string($_GET['is_pos_order']);
    $conditions[] = "o.IsPOSOrder = '$is_pos_order'";
}
...
$sql .= " GROUP BY o.OrderID ORDER BY o.OrderDate DESC LIMIT 10";
        ...
        <?php if ($result->num_rows > 0): ?>
            ...
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td class="fs-sm">#G-Store:<?php echo $row['OrderID']; ?></td>
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-md">
                                <img class="rounded-circle" 
                                     ...
                                     alt="avatar" 
                                     onerror="this.onerror=null;this.src='https://grostore.themetags.com/public/backend/assets/img/placeholder-thumb.png?v=v4.3.0';" />
                            </div>
                            <div class="ms-2">
                                <h6 class="fs-sm mb-0"><?php echo htmlspecialchars($row['CID']); ?>  </h6>
                                <span class="text-muted fs-sm"></span> <!-- Update with actual customer number -->
                            </div>
                        </div>
                    </td>
                    <td><span class="fs-sm"><?php echo date("d M, Y", strtotime($row['OrderDate'])); ?></span></td>
                    <td class="tt-tb-price"><span class="fw-bold"><?php echo $row['Items']; ?></span></td>
                    <td>
                        <span class="badge bg-soft-<?php echo ($row['PaymentStatus'] == 'Completed') ? 'success' : 'danger'; ?> rounded-pill text-capitalize">
                            <?php echo htmlspecialchars($row['PaymentStatus']); ?>
                        </span>
                    </td>
                    <td>
                        <span class="badge bg-soft-info rounded-pill text-capitalize"><?php echo htmlspecialchars($row['OrderStatus']); ?></span>
                    </td>
                    <td>
                        <span class="badge rounded-pill text-capitalize bg-secondary">N/A</span> <!-- Placeholder for Order Type -->
                    </td>
                    <td>
                        <span class="badge rounded-pill text-capitalize bg-secondary">N/A</span> <!-- Placeholder for Location -->
                    </td>
                    <td class="text-end">
                        <a href="https://grostore.themetags.com/admin/orders/<?php echo $row['OrderID']; ?>" 
                           class="btn btn-sm p-0 tt-view-details" 
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <tr><td colspan="10" class="text-center">No recent orders found</td></tr>
        <?php endif; ?>
    </tbody>
</table>
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    <h6 class="fs-sm mb-0">Mark Transssss - CEOS</h6>
                                        ...
                                        <td>
                                            <span class="fs-sm">04 Apr, 2024</span>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="badge rounded-pill text-capitalize bg-secondary">
                                                Regular
                                            </span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/139"
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/138"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/137"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">03 Apr, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/136"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">21 Jan, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/135"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">16 Jan, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/134"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">14 Jan, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/133"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">12 Jan, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/132"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">11 Jan, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/131"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/130"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span class="fs-sm">09 Jan, 2024</span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/129"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/128"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/127"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td>
                                            <span
                                                class="badge rounded-pill text-capitalize bg-soft-warning">
                                                Scheduled
                                            </span>
                                        </td>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/126"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
                                        ...
                                        <td class="text-end">
                                                                                                                                        <a href="https://grostore.themetags.com/admin/orders/125"
                                                    class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="View Details">
                                                    <i data-feather="eye"></i>
                                                </a>
        ...
        <ul class="pagination">
                    ...
                    <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                        ...
                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=2">2</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=3">3</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=4">4</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=5">5</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=6">6</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=7">7</a></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/orders?page=8">8</a></li>
                                                                        
            
                            <li class="page-item">
                    <a class="page-link" href="https://grostore.themetags.com/admin/orders?page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                </li>
                    </ul>
    </nav>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-center justify-content-md-end">
                    Grostore Online Store<strong class="ms-2">v4.3.0</strong>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/orders?lang_key=' + langKey + '&localize';
        }
