...
<!--                    <section class="tt-section pt-4">
            <div class="container">
                        ...
                        <div class="card tt-page-header">
                            <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                                <div class="tt-page-title">
                                    <h2 class="h5 mb-lg-0">TPS Report</h2>
                                </div>
                                <div class="tt-action">
              ...
              <?php
// Database connection and query to get the number of customers
...
?>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4" style="width: 200px;">
                                <div class="card h-100 flex-column"style="width:400px;">
                                    <div class="card-body d-flex flex-column h-100" >
                                        <span class="text-muted">Order By Category </span>
                                        <h4 class="fw-bold"></h4>
                                        <div id="topFive" >
                                            <canvas id="tpsChart" style="width: 2000px;"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
// Fetch data for today's sales
$query = "SELECT OrderID, TotalAmount FROM `order` WHERE DATE(OrderDate) = CURDATE()";
...
$orderIDs = array_column($data, 'OrderID');
$amounts = array_column($data, 'TotalAmount');
?>
         
               <div class="col-sm-6 col-md-4 col-lg-4"">
                                <div class="card h-100 flex-column">
                                    <div class="card-body d-flex flex-column h-100">
                                        <span class="text-muted"> Daily Sales Report</span>
                                        <h4 class="fw-bold"></h4>
                                        <div id="topFive" >
                                            <canvas id="dailySalesChart" style="width:700px;"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        const dailySalesChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($orderIDs); ?>,
                datasets: [{
                    label: 'Total Amount',
            ...
            options: {
                ...
                <?php
$conn = new mysqli("localhost", "root", "", "dailydeals");
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
}

// Fetch data for product sales performance
//$query = "SELECT p.Name, SUM(oi.Quantity) AS TotalSold
//          FROM product p
//          JOIN orderitem oi ON p.ProductID = oi.ProductID
//          JOIN `order` o ON o.OrderID = oi.OrderID
//          WHERE DATE(o.OrderDate) BETWEEN '2024-08-01' AND '2024-08-31'
//          GROUP BY p.Name";
$query = "SELECT p.Name, SUM(oi.Quantity) AS TotalSold
          FROM product p
          JOIN orderitem oi ON p.ProductID = oi.ProductID
          JOIN `order` o ON o.OrderID = oi.OrderID
          WHERE DATE(o.OrderDate) BETWEEN '2024-01-01' AND '2024-12-31'
          GROUP BY p.Name";
...
$totalSold = array_column($data, 'TotalSold');
?>
                                ...
                                <div class="col-l2">
                                    <div class="card"  style="width:1000px;">
                                        ...
                                        <div id="thisMonthChart" class="px-3">
                                             <canvas id="productSalesChart" style="width:100px;"></canvas>
                                        </div>
        ...
        <div class="row g-3 mb-3">
            <div class="col-xl-9">
                <div class="row g-3">
                    ...
                    <!-- Order by Category (Pie Chart) -->
                    <div class="col-sm-6 col-md-4 col-lg-4">
                        <div class="card h-100 flex-column" style="width: 140%;">
                            <div class="card-body d-flex flex-column h-100">
                                <span class="text-muted">Order By Category</span>
<!--                                <div id="topFive">-->
                                    <canvas id="tpsChart" style="width: 300%;"></canvas>
<!--                                </div>-->
                            </div>
                        </div>
                    </div>

                    <!-- Sales this Month (Bar Chart) -->
                    <div class="col-l2" style="padding-right: 100dp;">
                        <div class="card" style="width: 100%; margin-left: 70px;">
                            <div class="card-body pb-0">
                                <span class="text-muted">Product Sales Report</span>
                            </div>
<!--                            <div id="thisMonthChart" class="px-3">-->
                                <canvas id="productSalesChart" style="width: 100%;"></canvas>
<!--                            </div>-->
                        </div>
                    </div>
                </div>
...
var ctx1 = document.getElementById('tpsChart').getContext('2d');
var tpsChart = new Chart(ctx1, {
    type: 'pie',
    data: {
        labels: <?php echo json_encode($categories); ?>,
        datasets: [{
...
// Bar chart for Sales this Month
                            ...
                            <div class="card">
                                <div class="card-header border-bottom-0">
                                    <div class="row justify-content-between g-3">
                                        ...
                                        <div class="col-auto">
                                                                                            <a href="https://grostore.themetags.com/admin/orders" class="btn btn-primary">
...
$sql = "SELECT o.OrderID, o.CID, o.OrderDate, COUNT(oi.OrderItemID) AS Items, 
               p.PaymentStatus, o.OrderStatus, o.TotalAmount 
        FROM `order` o
                ...
                <div class="row justify-content-between g-3">
                    ...
                    <div class="col-auto">
                        <a href="orders.php" class="btn btn-primary">
                            <i data-feather="eye" width="18"></i> View All
                        </a>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    <?php if ($result->num_rows > 0): ?>
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                <td class="fs-sm ps-4">#Order: <?php echo $row['OrderID']; ?></td>
                                <td><?php echo $row['CID']; ?></td>
                                <td><?php echo date("d M, Y", strtotime($row['OrderDate'])); ?></td>
                                <td class="tt-tb-price"><span class="fw-bold"><?php echo $row['Items']; ?></span></td>
                                <td><span class="badge bg-soft-<?php echo ($row['PaymentStatus'] == 'Completed') ? 'success' : 'danger'; ?> rounded-pill text-capitalize">
                                    <?php echo $row['PaymentStatus']; ?>
                                </span></td>
                                <td><span class="badge bg-soft-info rounded-pill text-capitalize"><?php echo $row['OrderStatus']; ?></span></td>
                                <td class="text-end">
                                    <a href="order_details.php?order_id=<?php echo $row['OrderID']; ?>" class="btn btn-sm p-0 tt-view-details" data-bs-toggle="tooltip" title="View Details">
                                        <i data-feather="eye"></i>
                                    </a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr><td colspan="7" class="text-center">No recent orders found</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
...
$username = "root";
$password = "";
$dbname = "dailydeals"; // Change this to your actual database name
...
$sql = "SELECT COUNT(OrderID) AS totalOrders FROM `order`";  // Assuming your table is named 'order'
$result = $conn->query($sql);

// Fetch the total order count
$totalOrders = 0;
if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $totalOrders = $row['totalOrders'];
}
// Query to count total pending orders
$sql = "SELECT COUNT(OrderID) AS pendingOrders FROM `order` WHERE OrderStatus = 'pending'";
$result = $conn->query($sql);

// Fetch the total pending order count
$pendingOrders = 0;
if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
...
// Query to count total shipped orders
$sql = "SELECT COUNT(OrderID) AS shippedOrders FROM `order` WHERE OrderStatus = 'Shipped'";
$result = $conn->query($sql);

// Fetch the total shipped order count
$shippedOrders = 0;
if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
...
// Query to count total delivered orders
$sql = "SELECT COUNT(OrderID) AS deliveredOrders FROM `order` WHERE OrderStatus = 'Delivered'";
$result = $conn->query($sql);

// Fetch the total delivered order count
$deliveredOrders = 0;
if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    ...
    <div class="card h-100 flex-column">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    <h4 class="mb-1"><?php echo $totalOrders; ?></h4> <!-- Display total orders here -->
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1"><?php echo $pendingOrders; ?></h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1"><?php echo $shippedOrders; ?></h4>
                            ...
                            <div class="card h-100 flex-column">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <h4 class="mb-1"><?php echo $deliveredOrders; ?></h4>
