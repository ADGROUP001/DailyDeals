...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $isActive = isset($_POST['active']) ? 'Active' : 'Inactive'; // Set status based on checkbox

    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO category (Name, Description, IsActive) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $name, $description, $isActive);
