...
<head>
    ...
    <!--title-->
    <title>
            Order Details : Grostore Online Store
    </title>
                ...
                <ul class="navbar-nav flex-row align-items-center tt-top-navbar">
                    ...
                    <li class="nav-item dropdown tt-curency-lang-dropdown d-none d-md-block">
                        <a href="javascript:void(0);" class="nav-link" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img src="https://grostore.themetags.com/public/backend/assets/img/flags/en.png?v=v4.4.0"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end py-0 shadow border-0">
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        ...
                                        <img src="https://grostore.themetags.com/public/backend/assets/img/flags/sa.png?v=v4.4.0"
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        ...
                                        <img src="https://grostore.themetags.com/public/backend/assets/img/flags/fr.png?v=v4.4.0"
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        ...
                                        <img src="https://grostore.themetags.com/public/backend/assets/img/flags/ad.png?v=v4.4.0"
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        ...
                                        <img src="https://grostore.themetags.com/public/backend/assets/img/flags/es.png?v=v4.4.0"
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                        ...
                                        <img src="https://grostore.themetags.com/public/backend/assets/img/flags/br.png?v=v4.4.0"
                                ...
                                <a href="https://grostore.themetags.com/admin/orders" class="d-flex align-items-center">
                                    <h4 class="fs-md mb-0"><i data-feather="mail" width="18"
                                        ...
                                        An order has been procced to out_for_delivery</h4>
                                                    ...
                                                    <div class="p-3 position-relative border-bottom">
                                <a href="dashboard/support/reply/1" class="d-flex align-items-center">
                                    <h4 class="fs-md mb-0"><i data-feather="mail" width="18"
                                            class="me-1 text-success"></i>
                                        Customer Reply ticket</h4>
                                </a>
                            </div>
                                                    <div class="p-3 position-relative border-bottom">
                                <a href="https://grostore.themetags.com/admin/orders" class="d-flex align-items-center">
                                ...
                                <a href="https://grostore.themetags.com/admin/orders" class="d-flex align-items-center">
                                    <h4 class="fs-md mb-0"><i data-feather="mail" width="18"
                                        ...
                                        An order has been procced to picked_up</h4>
                                                    ...
                                                    <div class="p-3 position-relative border-bottom">
                                <a href="https://www.grostore.themetags.com/admin/orders" class="d-flex align-items-center">
                                    <h4 class="fs-md mb-0"><i data-feather="mail" width="18"
                                            class="me-1 text-success"></i>
                                        An order has been procced to delivered</h4>
                                </a>
                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                <a href="https://grostore.themetags.com/admin/orders/invoice-print/193" target="__blank" class="btn btn-dark">
                                    <i data-feather="printer" width="18"></i>
                                    Print
                                </a>
                                <a href="https://grostore.themetags.com/admin/orders/invoice-download/193" class="btn btn-primary">
                        ...
                        <div class="card-header border-bottom-0">
                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                    ...
                                    <span class="text-muted">Order Date:
                                        23 May, 2024
                                            ...
                                            <span class="text-muted">
                                                <i class="las la-map-marker"></i> Default Location
                                            </span>
                                        </div>
                                ...
                                <div class="col-auto col-lg-3">
                                    <label class="form-label">Assign Deliveryman</label>
                                    <div class="input-group">
                                ...
                                <div class="col-auto col-lg-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select select2" name="delivery_status"
                                            ...
                                            <option value="order_placed"  selected >
                                                Order Placed</option>
                            ...
                            <div class="row justify-content-between g-3">
                                <div class="col-xl-7 col-lg-6">
                                    <div class="welcome-message">
                                        ...
                                        <p class="mb-0">Name: Hassan</p>
                                        <p class="mb-0">Email: customer@themetags.com</p>
                                        <p class="mb-0">Phone: 5555555555</p>
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm"> <img
                                                        src="https://grostore.themetags.com/public/uploads/media/bbw2d73kLAmFHxl0EJDdNR5EzxH5uc7lxKLxpC9W.png"
                                                        alt="Black Grapes"
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹1,920.00
                                            </span>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm"> <img
                                                        src="https://grostore.themetags.com/public/uploads/media/mifuiZwatkPX702sY1QbikW1r3YQnonfTu3YY54u.png"
                                                        alt="Badhakopi (Cabbage)"
                                                        class="rounded-circle">
                                                </div>
                                                <div class="ms-2">
                                                    <h6 class="fs-sm mb-0">
                                        ...
                                        <td class="tt-tb-price">
                                            <span class="fw-bold">₹180.00
                                            </span>
                                        </td>
                                        <td class="fw-bold">1</td>

                                        <td class="tt-tb-price text-end">
                                                                                        <span class="text-accent fw-bold">₹180.00
                                            </span>
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹400.00
                                            </span>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm"> <img
                                                        src="https://grostore.themetags.com/public/uploads/media/BE7N2VlcmU1abeHNA01HpN5XSl01aNlsKXuKhN2c.png"
                                                        alt="Gala Apple ± 50 gm"
                                                        class="rounded-circle">
                                                </div>
                                                <div class="ms-2">
                                                    <h6 class="fs-sm mb-0">
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹2,160.00
                                            </span>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm"> <img
                                                        src="https://grostore.themetags.com/public/uploads/media/3udU8bhCm9Nw5hI0kmzMAVtvDTTMK4zgxkes4gGt.png"
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹24,000.00
                                            </span>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm"> <img
                                                        src="https://grostore.themetags.com/public/uploads/media/S42WBq4WDjzkDDNWlXpW1Ji1fzy9eOvs37HpWQ82.png"
                                                        alt="Cock Chicken Skin Off ± 25 gm"
                                                        class="rounded-circle">
                                                </div>
                                                <div class="ms-2">
                                                    <h6 class="fs-sm mb-0">
                                                        Cock Chicken Skin Off ± 25 gm
                                                    </h6>
                                                    <div class="text-muted">
                                                                                                                    <span class="fs-xs">
                                                                Weight:
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹8,000.00
                                            </span>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm"> <img
                                                        src="https://grostore.themetags.com/public/uploads/media/hkFbO8OEBfIrOk0yGNhDSMe3MvXCwNZwXnEAkrbj.png"
                                                        alt="Danish Condensed Filled Milk"
                                                        class="rounded-circle">
                                                </div>
                                                <div class="ms-2">
                                                    <h6 class="fs-sm mb-0">
                                                        Danish Condensed Filled Milk
                                                    </h6>
                                                    <div class="text-muted">
                                                                                                                    <span class="fs-xs">
                                                                Volume:
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹2,400.00
                                            </span>
                                        ...
                                        <td class="tt-tb-price text-end">
                                                                                            <span
                                                    class="badge bg-soft-info rounded-pill text-capitalize">refunded</span>
                                                                                        <span class="text-accent fw-bold">₹3,200.00
                                            </span>
                            ...
                            <div class="card-footer border-top-0 px-4 py-3 rounded">
                                <div class="row g-4">
                                    ...
                                    <div class="col-auto flex-grow-1">
                                        ...
                                        <span>Delivery By SimpleGraph</span>
                                    </div>
                                    ...
                                    <div class="col-auto text-lg-end ps-lg-5">
                                        ...
                                        <strong
                                            class="text-accent">₹980.00</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-center justify-content-md-end">
                    Grostore Online Store<strong class="ms-2">v4.4.0</strong>
                </div>
            </div>
        </div>
    </div>
...
<script type="module">
    import {Uppy, Dashboard, ImageEditor, DropTarget, XHRUpload} from "https://grostore.themetags.com/public/backend/assets/js/vendors/uppy.min.js?v=v4.4.0"
    var uppy = new Uppy({
            restrictions: { 
        ...
        .use(XHRUpload, {
            headers: {
                'X-CSRF-TOKEN': 'zwjQx5YdiJ23FtAnkBG1HiqL7aiFofjMoTj6pXJo',
            },
...
<script>
    ...
    function updateDeliveryStatusByDeliveryman(status, order_id) {
        $.post('https://grostore.themetags.com/deliveryman/orders/update-delivery-status', {
            _token: 'zwjQx5YdiJ23FtAnkBG1HiqL7aiFofjMoTj6pXJo',
            order_id: order_id,
            status: status
        }, function(data) {
    ...
    <!-- scripts from different pages -->
        ...
        $('#assign_deliveryman').on('change', function() {
            ...
            $.post('https://grostore.themetags.com/admin/orders/assign-deliveryman', {
                _token: 'zwjQx5YdiJ23FtAnkBG1HiqL7aiFofjMoTj6pXJo',
                order_id: order_id,
                deliveryman_id: deliveryman_id
            }, function(data) {
                notifyMe('success', 'Deliveryman has been updated');
                window.location.reload();
            });
        });
        ...
        $('#update_payment_status').on('change', function() {
            ...
            $.post('https://grostore.themetags.com/admin/orders/update-payment-status', {
                _token: 'zwjQx5YdiJ23FtAnkBG1HiqL7aiFofjMoTj6pXJo',
                order_id: order_id,
                status: status
            }, function(data) {
        ...
        $('#update_delivery_status').on('change', function() {
            ...
            $.post('https://grostore.themetags.com/admin/orders/update-delivery-status', {
                _token: 'zwjQx5YdiJ23FtAnkBG1HiqL7aiFofjMoTj6pXJo',
                order_id: order_id,
                status: status
            }, function(data) {
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/orders/193?lang_key=' + langKey + '&localize';
        }
