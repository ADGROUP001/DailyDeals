...
<head>
    ...
    <!--title-->
    <title>
            Categories : DailyDeals Online Store
    </title>
                ...
                <div class="col-12">
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            ...
                            <div class="tt-action">
                                                                    <a href="/DailyDeals/Dashboard/Add_Category.php" class="btn btn-primary"><i
            ...
            <div class="row g-4">
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        <form class="app-search" action="https://grostore.themetags.com/admin/products/category" method="GET">
        ...
        echo "<td class='text-end'>
                <div class='dropdown tt-tb-dropdown'>
                    ...
                    <div class='dropdown-menu dropdown-menu-end shadow'>
                        <a class='dropdown-item' href='update-category.php?id=" . $row['CategoryID'] . "'><i data-feather='edit-3' class='me-2'></i>Edit</a>
                        <a href='#' class='dropdown-item confirm-delete' data-href='delete-category.php?id=" . $row['CategoryID'] . "' title='Delete'><i data-feather='trash-2' class='me-2'></i>Delete</a>
                    </div>
                </div>
            </td>";
        echo "</tr>";
        ...
        <ul class="pagination">
                    ...
                    <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                        ...
                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                <li class="page-item"><a class="page-link" href="https://grostore.themetags.com/admin/products/category?page=2">2</a></li>
                                                                        
            
                            <li class="page-item">
                    <a class="page-link" href="https://grostore.themetags.com/admin/products/category?page=2" rel="next" aria-label="Next &raquo;">&rsaquo;</a>
                </li>
                    </ul>
    </nav>
...
<script>
    ...
    <!-- scripts from different pages -->
        ...
        function updateFeatureStatus(el) {
            ...
            $.post('https://grostore.themetags.com/admin/products/update-feature-category', {
                    _token: 'jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO',
                    id: el.value,
                    status: status
                },
        ...
        function updateTopStatus(el) {
            ...
            $.post('https://grostore.themetags.com/admin/products/update-top-category', {
                    _token: 'jWrIUYL5E59SINTNKdMmoqvWbXA9RaAXlnramIGO',
                    id: el.value,
                    status: status
                },
    ...
    <script>
        ...
        function localizeData(langKey) {
            window.location = 'https://grostore.themetags.com/admin/products/category?lang_key=' + langKey + '&localize';
        }
