...
<body>
 ...
 <img src="https://grostore.themetags.com/public/uploads/media/yqqPV512Gk5DMpvCj2UllKrCl52bam3yD6QvfiPP.png" class="tt-brand-favicon ms-1" alt="favicon" />
    ...
    <li class="side-nav-item nav-item">
        <a href="/SEM_4_DailyDeals/Dashboard/Test_Dashboard.php" class="side-nav-link">
    ...
    <!-- products -->
            ...
            <div class="collapse " id="sidebarProducts">
                <ul class="side-nav-second-level">
                                            ...
                                            <li
                            class="">
                            <a href="/SEM_4_DailyDeals/Dashboard/products.php" class="">All Products</a>

                        </li>
                    
                                            <li
                            class="">
                            <a href="/SEM_4_DailyDeals/Dashboard/category.php"
    ...
    <!-- orders -->
            ...
            <a href="http://localhost/SEM_4_DailyDeals/Dashboard/Order.php"
                class="side-nav-link ">
    ...
    <!-- customers -->
            <li class="side-nav-item nav-item">
            <a href="http://localhost/SEM_4_DailyDeals/Dashboard/Customer.php" class="side-nav-link">
    ...
    <!-- reports -->
            ...
            <div class="collapse " id="reports">
                <ul class="side-nav-second-level">
   <li class="">
                            <a href="http://localhost/SEM_4_DailyDeals/Dashboard/TPS_Report.php"
                                class="">TPS Report</a>
                        </li>
                    
                                            <li class="">
                            <a href="http://localhost/SEM_4_DailyDeals/Dashboard/MIS_Report.php"
                                class="">MIS Report</a>
                        </li>
                                    </ul>
            </div>
...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["code"])) {
    ...
    // Fetch product details based on code
    $sql = "SELECT * FROM Product WHERE code = '$code'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        // Product details fetched, proceed to display the edit form
?>
