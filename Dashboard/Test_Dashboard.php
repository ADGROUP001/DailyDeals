...
<body>
    ...
    <div class="preloader-wrap">
        <img src="Dashboard/Images/title_Logo.png" class="tt-brand-favicon ms-1" alt="favicon" />
        <h3>DailyDeals</h3>
    ...
    <div class="tt-brand">
        <a href="/DailyDeals/Dashboard/Test_Dashboard.php"
            class="tt-brand-link">
                                            ...
                                            <a class="nav-link px-0"
                                                ...
                                                <a class="nav-link px-0" href="https://grostore.themetags.com/admin/settings/general-settings">
                                                    ...
                                                    Settings
                                                                                ...
                                                                                <li class="nav-item">
                                            <a class="nav-link px-0" href="/DailyDeals/Forms/logout.php">
                            ...
                            <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                                ...
                                <div class="tt-action">
                                                ...
                                                data-feather="shopping-cart" class="me-2"></i>Manage Sales</a>-->
                                                                            ...
                                                                            <a href="/DailyDeals/Dashboard/add_products.php" class="btn btn-primary ms-2"><i
...
$sql_Categorys = "SELECT COUNT(*) AS product_count FROM category";
$result_Categorys = $conn->query($sql_Categorys);

$Category_count = 0;
if ($result_Categorys->num_rows > 0) {
    while($row = $result_Categorys->fetch_assoc()) {
        $Category_count = $row["product_count"];
    }
}
             ...
             <div class="col-sm-6 col-md-4 col-lg-4">
                                <div class="card h-100 flex-column">
                                    <div class="card-body d-flex flex-column h-100">
                                        <span class="text-muted">No of Category</span>
                                        <h4 class="fw-bold"><?php echo $Category_count;?></h4>
                                        <div id="topFive"></div>
                                    </div>
                                </div>
                            </div>
